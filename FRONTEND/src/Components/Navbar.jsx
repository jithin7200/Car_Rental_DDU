    ...
    <nav className="w-full bg-[#050816] border-b border-zinc-800 text-white px-6 lg:px-12 py-4 sticky top-0 z-50">
      <div className="flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">   Drive<span className="text-green-400">X</span>   </h1>
        ...
        <div className="hidden md:flex items-center gap-8 text-lg">
          <Link to="/" className="hover:text-green-400 transition">Home
          </Link>

          <Link
            to="/cars" className="hover:text-green-400 transition">Cars
          </Link>

          <Link to="/about" className="hover:text-green-400 transition" >About
          </Link>

          <Link to="/contact" className="hover:text-green-400 transition">Contact
          </Link>
        </div>
      ...
      {menuOpen && (
        <div className="md:hidden mt-6 flex flex-col gap-5 text-lg bg-[#0a0f1f] p-6 rounded-2xl border border-zinc-800">
          ...
          <Link
            to="/cars" className="hover:text-green-400" >
            Cars
          </Link>

          <Link
            to="/about" className="hover:text-green-400" >
            About
          </Link>
